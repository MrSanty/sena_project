/*
  ...
  - Made the column `description` on table `stock` required. This step will fail if there are existing NULL values in that column.
...
*/
-- AlterTable
ALTER TABLE "stock" ALTER COLUMN "description" SET NOT NULL;
